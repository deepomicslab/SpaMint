...
print(n_cores)
# ###
# st_dir = '/data6/wangjingwan/5.Simpute/4.datasets/E15_tg_rep30/spex/alter_sc_exp.tsv'
# st_meta_dir = '/data6/wangjingwan/5.Simpute/4.datasets/E15_tg_rep30/spex/spexmod_sc_meta.tsv'
# sc_coord_dir = '/data6/wangjingwan/5.Simpute/4.datasets/E15_tg_rep30/spex/spexmod_sc_meta.tsv'
# out_f = '/data6/wangjingwan/5.Simpute/4.datasets/E15_tg_rep30/spex/spa/'
# meta_key = 'celltype'
# species = 'Mouse'

# st_dir = '/data6/wangjingwan/5.Simpute/2.SCC/v9_spex/SCC_c2l/spex/alter_sc_exp.tsv'
# sc_coord_dir = '/data6/wangjingwan/5.Simpute/2.SCC/v9_spex/SCC_c2l/spex/spexmod_sc_meta.tsv'
...
# st_dir = '/data6/wangjingwan/5.Simpute/4.datasets/BR_c2l_S1_rep50/spex/alter_sc_exp.tsv'
# st_meta_dir = '/data6/wangjingwan/5.Simpute/4.datasets/BR_c2l_S1_rep50/spade/pattern2_bigsubtype_sc_agg_meta.tsv'
# sc_coord_dir = '/data6/wangjingwan/5.Simpute/4.datasets/BR_c2l_S1_rep50/spade/pattern2_bigsubtype_sc_agg_meta.tsv'
# meta_key = 'celltype'
# species = 'Human'
# out_f = '/data6/wangjingwan/5.Simpute/4.datasets/BR_c2l_S1_rep50/spex/spa/'
##########
...
if (grepl('Human', species)){
    ...
    max_hop = 4
    # add neuronchat db
    lr_df_dir = '/data6/wangjingwan/5.Simpute/SpexMod_v9/LR/mouse_LR_pairs.txt'
...
print('substitut 1')
# Filtering
# st_meta$celltype = gsub(" ", "-",st_meta[meta_key])
# print('sub space to -')
