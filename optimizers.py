...
def aff_embedding(alter_sc_exp,st_coord,sc_meta,lr_df,save_path,left_range,right_range,steps,dim):
    ...
    coord = embedding(sparse_A, ans, save_path, True, left_range, right_range, steps, dim)
