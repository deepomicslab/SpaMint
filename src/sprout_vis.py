...
# checking if sc_knn is correct
# sc_coord = pd.DataFrame(sc_coord,columns = ['x','y'])
# sc_coord['index'] = sc_coord.index
# sc_coord['color'] = '#ccc'
# sc_coord.loc[sc_coord['index'] == 0,'color'] = 'red'
# sc_coord.loc[sc_coord['index'].isin(sc_knn[0]),'color'] = 'blue'
# plt.scatter(sc_coord['x'], sc_coord['y'], s = 7, c = sc_coord['color'])
